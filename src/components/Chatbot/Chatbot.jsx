...
const Chatbot = () => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div 
          className="fixed bottom-28 sm:bottom-32 right-6 z-40 w-96 h-[700px] sm:w-[400px] sm:h-[600px] max-w-[calc(100vw-3rem)] max-h-[calc(100vh-4rem)] bg-dark-800/98 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl animate-in slide-in-from-bottom-2 duration-300 flex flex-col"
          ...
          <div className="p-6 border-t border-white/10 bg-gradient-to-r from-dark-800/50 to-dark-700/50 rounded-b-3xl">
            <form onSubmit={handleSendMessage} className="flex space-x-3">
              <input
                ...
                className="flex-1 bg-white/5 backdrop-blur-sm text-white placeholder-neutral-400 px-4 py-3 rounded-xl text-base focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent border border-white/10 focus:border-primary-500/50"
              />
              <button
                type="submit"
