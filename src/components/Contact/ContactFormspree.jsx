...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaSpinner, FaCheck, FaExclamationTriangle } from "react-icons/fa";
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8" data-aos="fade-right">
            ...
            <div className="flex items-start gap-4 group">
              <div className="bg-warning-500/20 p-3 rounded-full group-hover:bg-warning-500/30 transition-colors duration-300">
                <FaMapMarkerAlt className="text-warning-400 text-xl" />
              </div>
              <div>
                <h3 className="heading-3 mb-2">Visit Us</h3>
                <p className="body-text">123 Innovation Drive, Tech City, CA 90210</p>
              </div>
            </div>
          </div>
